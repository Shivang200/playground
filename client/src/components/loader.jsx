...
const Loader = () => {
  ...
  return (
    isLoading && (
      ...
      >
        <h1 className="text-3xl font-bold text-transparent bg-gradient-to-r from-purple-400 via-indigo-500 to-blue-500 bg-clip-text drop-shadow-[0_0_20px_rgba(120,80,255,1)]">
          TALK
        </h1>
        <h1 className="text-3xl font-bold text-transparent bg-gradient-to-r from-purple-400 via-indigo-500 to-blue-500 bg-clip-text drop-shadow-[0_0_20px_rgba(120,80,255,1)]">
          CONNECT
